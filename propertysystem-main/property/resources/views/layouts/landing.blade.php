                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s">{{__('MyBoma360 - Property Management System')}}</h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s">{{__('Your Boma, Our Technology .')}}</p>
                        <a class="btn btn-primary" href="{{route('login')}}" data-wow-duration="1.8s"><i
                                class="fa fa-television" aria-hidden="true"></i>{{__('Free Trial')}} </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    ...
                    <h1 class="wow fadeInRight">{{__('Why Choose US')}}</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Dashboard')}}</h5>
                                    <p>{{__('Your all-in-one control center. Get a clear overview of tenants, payments, properties, and maintenance requests in one place.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Property')}}</h5>
                                    <p>{{__('Manage all types of properties with ease—whether it’s apartments, estates, Airbnb units, or office spaces. Keep everything organized, monitored, and powered by smart tech in one platform.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    ...
                                    <p>{{__('Get a full snapshot of each property, including unit info, occupancy status, rental rates, and maintenance records, all in one view.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Tenant')}}</h5>
                                    <p>{{__('Track tenant details, lease agreements, and payment history effortlessly for smooth management and better relationships.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Invoice')}}</h5>
                                    <p>{{__('Create and send professional invoices for rent, utilities, or service charges. Automate reminders, track payments, and keep records tidy.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
